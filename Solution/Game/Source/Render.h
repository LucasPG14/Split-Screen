...
public:
	...
	// Drawing
	bool DrawTexture(Camera* camera, SDL_Texture* texture, int x, int y, const SDL_Rect* section = NULL, SDL_Rect cam = {0,0,0,0}, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;

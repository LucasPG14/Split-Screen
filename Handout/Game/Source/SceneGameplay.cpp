...
bool SceneGameplay::Load(Textures* tex, Audio* audio, Render* render, DisplayType type)
{
	...
	// TODO 3: Use the function of the Scene class to create the cameras.
	...
	// TODO 4: Create and add players to the list of players. You have to create many players as cameras.
	// Also, use the function you filled before in the render class, to assign a camera to the player.
